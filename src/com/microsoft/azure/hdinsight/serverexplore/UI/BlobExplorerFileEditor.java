...
public class BlobExplorerFileEditor implements FileEditor {
    ...
    public BlobExplorerFileEditor() {
        ...
        blobListTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent listSelectionEvent) {
                boolean isFileSelected = !isDirectorySelected() && blobListTable.getSelectedRow() >= 0;

                deleteButton.setEnabled(isFileSelected);
                openButton.setEnabled(isFileSelected);
                saveAsButton.setEnabled(isFileSelected);
            }
        });
            ...
            public void mousePressed(MouseEvent me) {
                if (me.getComponent() instanceof JTable) {
                    ...
                    if (me.getButton() == 3) {
                        ...
                        if (fileSelection != null  && !isDirectorySelected()) {
                        ...
                        public void run() {
                            ...
                            for (BlobItem blobItem : blobItems) {
                                if (blobItem instanceof BlobDirectory) {
                                    ...
                                    model.addRow(new Object[]{
                                            PluginUtil.getIcon(CommonConst.BlobFileIConPath),
                                            blobFile.getName(),
    ...
    private boolean isDirectorySelected() {
        ...
        if (selectedRow < 0) {
            ...
            String type = (String)blobListTable.getValueAt(selectedRow, 4);
            return type != null && type.toLowerCase().equals("dictionary");
        }
    }
