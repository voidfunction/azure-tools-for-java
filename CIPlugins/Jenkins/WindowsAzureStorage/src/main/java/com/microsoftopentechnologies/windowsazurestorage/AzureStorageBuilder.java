...
public class AzureStorageBuilder extends Builder {
	...
	public static final class AzureStorageBuilderDesc extends
		...
		public List<String> getContainersList(String StorageAccountName) {
			try {
				return WAStorageClient.getContainersList(
						getStorageAccount(StorageAccountName), false);
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
		...
		public List<String> getBlobsList(String StorageAccountName,
				String containerName) {
			try {
				return WAStorageClient.getContainerBlobList(
						getStorageAccount(StorageAccountName), containerName);
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
		 ...
		 * 
		 * @QueryParameter String containerName) {
		 * System.out.println("storageAccName--------->"+storageAccName);
		 * System.out.println("containerName--------->"+containerName);
		 * List<String> blobList = getBlobsList(storageAccName, containerName);
		 * AutoCompletionCandidates autoCand = null;
		 * 
