...
public class AcquireTokenInteractiveHandler extends AcquireTokenHandlerBase {
    ...
    public AcquireTokenInteractiveHandler(Authenticator authenticator, TokenCache tokenCache, String resource, 
    ...
    void acquireAuthorization() throws Exception {                
    ...
    private URI createAuthorizationUri(boolean includeFormsAuthParam) throws Exception {
        ...
        URI authorizationUri = new URI(this.authenticator.authorizationUri + "?" + UriUtils.toQueryString(requestParameters));
        return authorizationUri;
    }

    private Map<String, String> createAuthorizationRequest(String loginHint, boolean includeFormsAuthParam) {
        Map<String, String> authorizationRequestParameters = new HashMap<String, String>();
    ...
    private void verifyAuthorizationResult() throws Exception {
        if (this.promptBehavior == PromptBehavior.Never 
        		&& this.authorizationResult.error == OAuthError.LoginRequired) {
